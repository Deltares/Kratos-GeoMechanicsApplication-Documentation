...
The user can recreate this input by from the GUI of D-Geo Flow. After opening the application, the user can draw the geometry, assign material properties to the layers, define flow boundaries and assign a calculation type and calculation properties. In the [user manual of D-Geo Flow](https://download.deltares.nl/d-geo-flow), this is explain in more detail.
