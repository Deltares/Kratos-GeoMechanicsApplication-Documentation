...
The GeoMechanics Application supports both built‑in models and user‑defined soil models (UDSM), allowing users to incorporate advanced or project‑specific formulations. External libraries of models are widely used in practice. For example, the website [SoilModels](https://soilmodels.com/) provides a curated database of constitutive models, calibration tools, and implementations for different finite element codes, supporting the selection and validation of appropriate models. 

Within Deltares, soil model development is closely linked to research and validation efforts, bridging laboratory testing, calibration workflows, and numerical simulation. These soil models are internally available on [github](https://github.com/Deltares-research/soil-models) and [TeamCity](https://dpcbuild.deltares.nl/project/GEOCONST). Contact the [Kratos team](mailto: {{authoremail}}) for more information about the soil models that are being developed within Deltares.
